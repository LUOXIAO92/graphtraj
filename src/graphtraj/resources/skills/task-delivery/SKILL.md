...
decision. Runtime success alone does not establish acceptance. For a coding
budget notice or forced stop, read [the budget response](references/coding-budget.md).
For an execution
