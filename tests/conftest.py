...
def fake_codex(tmp_path: Path) -> FakeCodex:
    ...
    script = "#!{0}\n".format(sys.executable) + (
        ...
        "        if ((not inline_specialist and stage < 2) or "
        "(inline_specialist and stage < 3)):\n"
        "            roles = (\n"
        "                ['investigation-specialist']\n"
        "                if inline_specialist and stage == 0\n"
        "                else ['engineer-junior']\n"
        "                if stage == (1 if inline_specialist else 0)\n"
        ...
        "                ]\n"
        "                if child_role == 'investigation-specialist':\n"
        "                    lines += [\n"
        "                        '    role:',\n"
        "                        '      investigation-specialist:',\n"
        "                        '        runtime: codex',\n"
