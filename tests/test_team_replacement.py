...
def test_installed_team_and_member_replacement(
    ...
    script = script.replace("'leader-stage'", "('leader-stage-' + os.environ.get('GRAPHTRAJ_TEAM_GENERATION', '1'))")
    script = script.replace("delivered.write_text('complete team round\\n')", "delivered.write_text('team ' + os.environ.get('GRAPHTRAJ_TEAM_GENERATION', '1'))")
