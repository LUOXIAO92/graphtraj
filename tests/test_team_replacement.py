...
""")
    ...
    if not during_implementation:
        ...
        # A replaced member keeps its Team generation and takes a free entity
        # name instead of overwriting the Session it succeeds.
        assert current["members"]["engineer"]["session_ref"] == (
            "76-session_alias_control-handover0-engineer@engineer_2"
        )
